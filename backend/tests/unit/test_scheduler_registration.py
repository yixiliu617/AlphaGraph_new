...
def test_all_jobs_register_with_expected_cron():
    ...
    expected = [
        ...
        ("tpex_openapi_sync",       sm.job_tpex_openapi_sync,      CronTrigger(hour="11", minute="0")),
    ...
    assert "hour='11'" in str(by_id["tpex_openapi_sync"].trigger)
